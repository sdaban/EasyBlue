...
INSERT INTO `ea_mois` (`id`, `name`) VALUES
	(1, 'january'),
	(2, 'february'),
	(3, 'march'),
	(4, 'april'),
...
INSERT INTO `ea_settings` (`id`, `name`, `value`) VALUES
	...
	(2, 'book_advance_timeout', '240'),
	(3, 'reminder_days_out', '1,3'),
	(4, 'google_analytics_code', ''),
	(5, 'customer_notifications', '1'),
	(6, 'date_format', 'DMY'),
	(7, 'require_captcha', '0'),
	(8, 'time_format', '24HR'),
	(9, 'max_date', '30'),
	(10, 'interval_time', '30'),
	(11, 'theme_color', 'green'),
	(12, 'week_starts_on', 'sunday'),
	(13, 'show_free_price_currency', 'yes'),
	(14, 'show_any_provider', 'yes'),
	(15, 'show_minimal_details', 'no'),
	(16, 'conf_notice', 'no'),
	(17, 'google_sync_notice', 'no'),
	(18, 'google_sync_from', ''),
	(19, 'google_sync_to', ''),
	(20, 'wp_invoice','no'),
	(21, 'company_name', 'Ville de Bezons -TEST'),
	(22, 'company_email', 'noreply@mairie-bezons.fr'),
	(23, 'company_link', 'www.ville-bezons.fr');
